...
public class EmployeeController {
	...
	public final EmployeeRespository repository;
	public final EmployeeModelAssembler assembler;

	EmployeeController(EmployeeRespository repository, EmployeeModelAssembler assembler) {
	...
	/*
	 * Employee newEmployee(@RequestBody Employee newEmployee) { return
